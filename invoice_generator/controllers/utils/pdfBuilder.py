...
class PDF(FPDF):
    ...
    '''
    def __init__(self, invoice_table_data, pdfs_folder):
        super().__init__()
        ...
        self.footer_text = "We request that you pay this invoice within 14 days of the invoice date, stating the invoice number,  to be paid to bank account number NL18INGB0005876441 in the name of VipaHelda BV in Capelle aan den IJssel"
        
        self.set_margins(15, 5, 15)
    ...
    def header(self):
        ...
        # Move to the right
        self.set_xy(-70, 15)
        if os.path.exists(self.pdfs_folder + '/logo/header_logo.png'):
            self.image(name=self.pdfs_folder + "/logo/header_logo.png", w=50)
    ...
    def footer(self):
        ...
        self.set_y(-20)
        self.write(h=5, txt=self.footer_text)
