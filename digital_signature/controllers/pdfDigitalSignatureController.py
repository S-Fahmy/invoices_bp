...
from self_signed_certs.controllers.selfSignCertificate import selfSignedCert


def sign_pdf_file(pdf_name, certs_location, pdfs_location, sig_img_location, sig_position):
    ...
    try:
        ...
        with open(pdfs_location + '/' + pdf_name, 'rb+') as unsigned:
            ...
            # sign and overwrite this same file.
            pdf_signer.sign_pdf(pdf_file, in_place=True)
